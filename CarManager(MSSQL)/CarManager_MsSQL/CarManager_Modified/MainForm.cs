    ...
    public partial class MainForm : Form
    {
        ...
        private void selectQuery(int parkingSpot = -1)
        {
            if (parkingSpot < 0)
            {
                ...
                dataGridView_parkingManager.DataSource = DBHelper.ds;
        ...
        private void button_parkingAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        string ParkedCar = DBHelper.dt.Rows[0]["CarNumber"].ToString();
                        if (ParkedCar != "")
                        {
                        ...
                        DBHelper.updateQuery(textBox_parkingSpot.Text, textBox_carNumber.Text, textBox_driverName.Text, textBox_phoneNumber.Text);
            ...
            else
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        bool isRemove = true;
                        DBHelper.updateQuery(textBox_parkingSpot.Text, "", "", "", isRemove);
